...
from SpiffWorkflow.specs import TransMerge, Transform, Simple


class TransMergeTest(TaskSpecTest):
    CORRELATE = Transform
    ...
    def create_instance(self):
        ...
        return TransMerge(self.wf_spec,
                       'testtask',
                       description='foo',
                       transforms=[''])
...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(TransMergeTest)
